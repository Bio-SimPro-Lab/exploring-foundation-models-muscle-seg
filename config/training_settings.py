...
def parse_args():    
    ...
    parser.add_argument('-dataset_name', type=str, default='Muscle_segmentation', help='the name of dataset to be finetuned')
    
    parser.add_argument('-img_folder', type=str, default=r"datasets\Muscle_segmentation\img_IP", help='the folder putting images')
    parser.add_argument('-mask_folder', type=str, default=r"datasets\Muscle_segmentation\mask", help='the folder putting masks')
    parser.add_argument('-train_img_list', type=str, default=r"datasets\Muscle_Segmentation\files\train_fold0.csv")
    parser.add_argument('-val_img_list', type=str,default=r"datasets\Muscle_Segmentation\files\validation_fold0.csv")
    ...
    parser.add_argument('-dir_checkpoint', type=str, default=r"checkpoints\MedSAM\Decoder", help='the checkpoint folder to save final model')
    parser.add_argument('-num_cls', type=int, default=13, help='the number of output channels (need to be your target cls num +1)')
